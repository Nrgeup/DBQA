...
flags.DEFINE_boolean('position_needed', True, 'is position embedding used')
flags.DEFINE_string('data', 'nlpcc', 'data set')
...
flags.DEFINE_integer('gpu', '1', 'gpu number')
...
flags.DEFINE_string('embedding_file', 'model/sgns.baidubaike.bigram-char', 'pre-trained chinese embedding')
flags.DEFINE_string('stopwords', 'model/chStopWordsSimple.txt', 'chinese stopwords')
flags.DEFINE_string('vocab_file', 'model/vocab.bin', 'vocab_file')
flags.DEFINE_string('embedding', 'model/embedding.bin', 'embedding')
flags.DEFINE_string('missword_file', 'model/missword.txt', 'words that not in dict')
